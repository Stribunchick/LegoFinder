...
class Ui_AddPartWindow(object):
    def setupUi(self, AddPartWindow):
        ...
        self.part_name_lineedit = QLineEdit(AddPartWindow)
        self.part_name_lineedit.setObjectName(u"part_name_lineedit")

        self.horizontalLayout_2.addWidget(self.part_name_lineedit)
        ...
        self.process_template_button = QPushButton(AddPartWindow)
        self.process_template_button.setObjectName(u"process_template_button")

        self.verticalLayout_3.addWidget(self.process_template_button)
    ...
    def retranslateUi(self, AddPartWindow):
        AddPartWindow.setWindowTitle(QCoreApplication.translate("AddPartWindow", u"\u0414\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u0434\u0435\u0442\u0430\u043b\u0438", None))
        ...
        self.process_template_button.setText(QCoreApplication.translate("AddPartWindow", u"\u041e\u0431\u0440\u0430\u0431\u043e\u0442\u0430\u0442\u044c \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435", None))
    # retranslateUi
